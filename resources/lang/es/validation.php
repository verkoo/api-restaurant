...
return [
    ...
    */
    ...
    'after_or_equal'       => 'El campo :attribute debe ser una fecha anterior a :date.',
    ...
    'should_be_true' => 'Establezca como favorita otra dirección antes de desmarcar la actual',
    ...
    */
    ...
    'custom' => [
        ...
        'products.*.stock' => [
            ...
            'numeric' => 'El campo stock debe ser numérico',
        ],
        'delivery_notes' => [
            'has_lines' => 'Al menos un albarán no tiene lineas. Imposible facturar',
        ],
        'delivery_notes' => [
            'not_billed' => 'Al menos un albarán ya ha sido facturado. Imposible facturar',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'pagination'    => 'Elementos por Página',
        'ean13'         => 'Código de Barrras',
        'improver_id'   => 'Mejorante',
        'yeast_id'      => 'Levadura',
        'growing_id'    => 'Creciente',
        'flour_id'      => 'Harina',
        'other_id'      => 'Otro',
        'start'         => 'Inicio',
        'end'           => 'Fin',
